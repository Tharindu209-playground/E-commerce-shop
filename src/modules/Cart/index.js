        ...
        <div className="container mx-auto mt-10">
          <div className="flex shadow-md my-10">
                    ...
                    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                      <div className="flex w-2/5">
                        ...
                        <div className="flex flex-col justify-between ml-4 flex-grow">
                          ...
                          <div className="absolute font-semibold hover:text-red-500 text-gray-500 text-xs cursor-pointer right-1/3" onClick={() => removeProduct(cart?.id)}>remove ❌</div>
                        </div>
                      </div>
            ...
            <div id="summary" className="w-1/4 px-8 py-10">
              <h1 className="text-white font-semibold text-2xl border-b pb-8">Order Summary</h1>
              <div className="text-white flex justify-between mt-4 mb-3">
                <h4 className="font-semibold text-sm uppercase">Item Count</h4>
                <span className="font-semibold text-sm">{carts?.length}</span>
              </div>
              <div className="text-white flex justify-between mt-10 mb-5">
                <h4 className="font-semibold text-sm uppercase">Total </h4>
                <span className="font-semibold text-sm">$ {total?.toFixed(2)}</span>
              </div>
              <div>
                <label className="text-white  font-medium inline-block mb-3 text-sm uppercase">Shipping</label>
              ...
              <div className="py-10">
                <label for="promo" className="text-white  font-semibold inline-block mb-3 text-sm uppercase">Promo Code</label>
